...
export const TOKEN_TABLE = [
  '！',   '～',   '喵喵',   '咪喵',   '喵呜',   '咪呜',   '喵嗷',   '咪嗷',   '呼噜',   '咕噜',
   ...
   '（=^w^=）',   '(=^ω^=)',   '（=^ω^=）',   '(=^x^=)',   '（=^x^=）',   '(=^ェ^=)',   '（=^ェ^=）',   '(=^ᆺ^=)',   '（=^ᆺ^=）',   '(=^人^=)',
   '（=^人^=）',   '(=^ᴥ^=)',   '（=^ᴥ^=）',   '(=^ﻌ^=)',   '（=^ﻌ^=）',   '(=•ω•=)',   '（=•ω•=）',   '(=•ᆺ•=)',   '（=•ᆺ•=）',   '(=•ﻌ•=)',
   '（=•ﻌ•=）',   '(=•ㅅ•=)',   '（=•ㅅ•=）',   '(=•ᴥ•=)',   '（=•ᴥ•=）',   '(=•ェ•=)',   '（=•ェ•=）',   '(=ΦωΦ=)',   '（=ΦωΦ=）',   '(=ΦﻌΦ=)',
   '（=ΦﻌΦ=）',   '(=ΦᴥΦ=)',   '（=ΦᴥΦ=）',   '(=ΦェΦ=)',   '（=ΦェΦ=）',   '(=ΦᆺΦ=)',   '（=ΦᆺΦ=）',   '(ฅ^•ﻌ•^ฅ)',   '（ฅ^•ﻌ•^ฅ）',   '(ฅ^•ω•^ฅ)',
   '（ฅ^•ω•^ฅ）',   '(ฅ^•ㅅ•^ฅ)',   '（ฅ^•ㅅ•^ฅ）',   '(ฅ^•ᆺ•^ฅ)',   '（ฅ^•ᆺ•^ฅ）',   '(ฅ^•ᴥ•^ฅ)',   '（ฅ^•ᴥ•^ฅ）',   '(ฅ^•ェ^ฅ)',   '（ฅ^•ェ^ฅ）',   '(ฅ^..^ฅ)',
   '（ฅ^..^ฅ）',   '(ฅ^^ฅ)',   '（ฅ^^ฅ）',   '(ฅ^o^ฅ)',   '（ฅ^o^ฅ）',   '(ฅ^w^ฅ)',   '（ฅ^w^ฅ）',   '(ฅ^ω^ฅ)',   '（ฅ^ω^ฅ）',   '(ฅ^x^ฅ)',
   '（ฅ^x^ฅ）',   '(ฅ^ェ^ฅ)',   '（ฅ^ェ^ฅ）',   '(ฅ^ﻌ^ฅ)',   '（ฅ^ﻌ^ฅ）',   '(ฅ•ω•ฅ)',   '（ฅ•ω•ฅ）',   '(ฅ•ᆺ•ฅ)',   '（ฅ•ᆺ•ฅ）',   '(ฅ•ﻌ•ฅ)',
   '（ฅ•ﻌ•ฅ）',   '(ฅ•ㅅ•ฅ)',   '（ฅ•ㅅ•ฅ）',   '(ฅ•ᴥ•ฅ)',   '（ฅ•ᴥ•ฅ）',   '(ฅ•ェ•ฅ)',   '（ฅ•ェ•ฅ）',   '(ฅΦωΦฅ)',   '（ฅΦωΦฅ）',   '(ฅΦﻌΦฅ)',
   '（ฅΦﻌΦฅ）',   '(ฅΦᴥΦฅ)',   '（ฅΦᴥΦฅ）',   '(ฅΦェΦฅ)',   '（ฅΦェΦฅ）',   '(^•ﻌ•^)',   '（^•ﻌ•^）',   '(^•ω•^)',   '（^•ω•^）',   '(^•ㅅ•^)',
   '（^•ㅅ•^）',   '(^•ᆺ•^)',   '（^•ᆺ•^）',   '(^•ᴥ•^)',   '（^•ᴥ•^）',   '(^•ェ^)',   '（^•ェ^）',   '(^..^)',   '（^..^）',   '(^_^)',
   '（^_^）',   '(^o^)',   '（^o^）',   '(^w^)',   '（^w^）',   '(^ω^)',   '（^ω^）',   '(^x^)',   '（^x^）',   '(^ェ^)',
   '（^ェ^）',   '(^ﻌ^)',   '（^ﻌ^）',   '(•ω•)',   '（•ω•）',   '(•ᆺ•)',   '（•ᆺ•）',   '(•ﻌ•)',   '（•ﻌ•）',   '(•ㅅ•)',
   '（•ㅅ•）',   '(•ᴥ•)',   '（•ᴥ•）',   '(•ェ•)',   '（•ェ•）',   '(ΦωΦ)',
