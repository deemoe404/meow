...
expect(screen.getByText('nya152-zh10')).toBeTruthy();
    ...
    <header class="top-bar">
      <div class="brand-lockup">
        ...
        <div>
          ...
          <p>本地可逆编码，把 Unicode 文本转换成 nya152-zh10 猫语串。</p>
        </div>
      </div>
      <div class="runtime-cluster" aria-live="polite">
        <span class="protocol-chip">nya152-zh10</span>
    ...
    <main class="workbench">
      ...
      <section class="protocol-strip" aria-label="协议状态">
        ...
        <details class="protocol-details">
          ...
          <p>UTF-8 原文 -> raw/zstd-dict -> frame -> base152 digit -> 152-token 猫语表。</p>
        </details>
      </section>
    </main>
  </section>
